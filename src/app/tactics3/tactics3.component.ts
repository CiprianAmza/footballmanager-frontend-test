...
@Component({
  selector: 'app-tactics3',
  templateUrl: './tactics3.component.html',
  styleUrls: ['./tactics3.component.css']
})
export class Tactics3Component implements OnInit, OnChanges {

  @Input() teamId!: number; // Input pentru reutilizare

  // Tabbed layout state (single-column mobile-first variant)
  activeTab: string = 'pitch';
  ...
  /** Vertical position (% from top) of the visual defensive-line overlay.
